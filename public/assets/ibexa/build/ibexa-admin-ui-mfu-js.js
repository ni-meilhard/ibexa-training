...
var prepareStruct = function prepareStruct(_ref2, data) {
  ...
  return getContentTypeByIdentifier(config, mapping.contentTypeIdentifier).then(function (response) {
    ...
    return window.ibexa.helpers.notification.showErrorNotification('Cannot get content type by identifier');
    ...
    return window.ibexa.helpers.notification.showErrorNotification('Cannot create content structure');
  });
};
