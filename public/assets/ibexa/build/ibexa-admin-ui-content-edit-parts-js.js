    ...
    _createClass(BaseFieldValidator, [{
      ...
      value: function toggleErrorMessage(validationResult, config, input) {
        ...
        var existingErrorSelectors = config.errorNodeSelectors.map(function (selector) {
          return "".concat(selector, " .ibexa-field-edit__error");
        });
...
(function (global, doc, ibexa, Leaflet, Translator) {
  ...
  doc.querySelectorAll(SELECTOR_FIELD).forEach(function (field) {
    ...
    var map = Leaflet.map(field.querySelector('.ibexa-data-source__map'), mapConfig);
    maps.push(map);
  ...
  doc.querySelectorAll(SELECTOR_FIELD).forEach(function (fieldContainer) {
    var validator = new EzImageFieldValidator({
      ...
      eventsMap: [{
        ...
        errorNodeSelectors: ["".concat(SELECTOR_ALT_WRAPPER, " .ibexa-data-source__label-wrapper")]
      }, {
        isValueValidator: false,
        selector: "".concat(SELECTOR_INPUT_FILE),
        eventName: 'ibexa-invalid-file-size',
...
(function (global, doc, ibexa, React, ReactDOM, Translator) {
  ...
  [].concat(_toConsumableArray(doc.querySelectorAll(SELECTOR_FIELD_MULTIPLE)), _toConsumableArray(doc.querySelectorAll(SELECTOR_FIELD_SINGLE))).forEach(function (fieldContainer) {
    ...
    var renderRow = function renderRow(item, index) {
      ...
      return rowTemplate.replace('{{ content_name }}', contentName).replace('{{ content_type_name }}', contentTypeName).replace('{{ published_date }}', formatShortDateTime(item.ContentInfo.Content.publishedDate)).replace('{{ order }}', selectedItems.length + index + 1);
    };
...
/***/ "./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/field-type/ezprofiledata.js":
/*!*****************************************************************************************************!*\
  !*** ./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/field-type/ezprofiledata.js ***!
  \*****************************************************************************************************/
/***/ (() => {
...
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
(function (global, doc, ibexa, Translator) {
  var SELECTOR_FIELD = '.ibexa-field-edit--ezprofiledata';
  var SELECTOR_VARIANTS_INPUT = '.ibexa-field-edit__profiledata-input';
  ...
  var ProfileDataRow = /*#__PURE__*/function () {
    ...
    function ProfileDataRow(_ref) {
      ...
      var addButton = row.querySelector('.ibexa-btn--add-address');
      if (addButton) {
    ...
    _createClass(ProfileDataRow, [{
      ...
      value: function addRowHTML() {
        ...
        var index = this.body.querySelectorAll('.ibexa-collapse').length;
        var template = this.body.dataset.template.replace('{{ INDEX }}', index).replaceAll('{{ ROW_ID }}', "".concat(this.name).concat(index));
        container.insertAdjacentHTML('beforeend', template);
        var row = container.querySelector('.ibexa-collapse');
        var trashButton = row.querySelector('.ibexa-btn--remove-address');
        ...
        doc.body.dispatchEvent(new CustomEvent('ibexa-initialize-card-toggle-group', {
          detail: {
            button: row.querySelector('.ibexa-collapse__toggle')
          }
        }));
        validator.reinit();
        return row;
      ...
      value: function createAdditionalField(row) {
        var _this2 = this;
        var additionalFieldsWrapper = row.querySelector('.ibexa-data-source--additional-fields');
      ...
      value: function deleteRow(event) {
        var row = event.target.closest('.ibexa-collapse');
      ...
      value: function setRowLabel(row, rowData) {
        ...
        row.querySelector('.ibexa-collapse__header .ibexa-label').innerHTML = rowLabel.filter(function (element) {
          return element;
        }).join(', ');
      }
    }, {
  ...
  var EzProfiledataValidator = /*#__PURE__*/function (_ibexa$BaseFieldValid) {
    "use strict";

    _inherits(EzProfiledataValidator, _ibexa$BaseFieldValid);
    ...
    _createClass(EzProfiledataValidator, [{
      ...
      value: function validateInput(event) {
        ...
        var label = event.target.closest(SELECTOR_FIELD).querySelector('.ibexa-field-edit__label').innerHTML;
        var errorMessage = Translator.trans( /*@Desc("Some required inputs in %fieldName% are missing")*/'profile_data.error', {
          fieldName: label
        }, 'field_types_ui');
        return {
          isError: isError,
...
(function (global, doc, ibexa, Routing) {
  ...
  var attachChangeCountryEvents = function attachChangeCountryEvents(addressField) {
    ...
    var formNode = addressField.querySelector('.ibexa-data-source__fields-wrapper');
...
(function (global, doc, ibexa, React, ReactDOM, Routing) {
  ...
  var toggleDisableState = function toggleDisableState(event) {
    var container = event.currentTarget.closest('.ibexa-field-edit--ezimageasset');
