...
var ContentCreateWidget = function ContentCreateWidget() {
  ...
  var createLabel = Translator.trans( /*@Desc("Create new")*/'create_content.create', {}, 'universal_discovery_widget');
  ...
  var createUnderLabel = Translator.trans( /*@Desc("under %content_name%")*/'content.create.editing_details', {
    content_name: selectedLocation === null || selectedLocation === void 0 ? void 0 : (_selectedLocation$loc = selectedLocation.location) === null || _selectedLocation$loc === void 0 ? void 0 : _selectedLocation$loc.ContentInfo.Content.TranslatedName
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    var _ref2 = _slicedToArray(_ref, 2),
      groupName = _ref2[0],
      groupItems = _ref2[1];
    var restrictedContentTypeIds = (_selectedLocation$per = selectedLocation === null || selectedLocation === void 0 ? void 0 : (_selectedLocation$per2 = selectedLocation.permissions) === null || _selectedLocation$per2 === void 0 ? void 0 : _selectedLocation$per2.create.restrictedContentTypeIds) !== null && _selectedLocation$per !== void 0 ? _selectedLocation$per : [];
...
var SelectedLocations = function SelectedLocations() {
  ...
  var renderActionButtons = function renderActionButtons() {
    var removeAllLabel = Translator.trans( /*@Desc("Remove all")*/'selected_locations.remove_all', {}, 'universal_discovery_widget');
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
var ContentCreateTabModule = function ContentCreateTabModule() {
  ...
  var handleIframeLoad = function handleIframeLoad() {
    ...
    iframeConfirmBtn === null || iframeConfirmBtn === void 0 ? void 0 : iframeConfirmBtn.addEventListener('click', publishContent, false);
    iframeCancelBtn === null || iframeCancelBtn === void 0 ? void 0 : iframeCancelBtn.addEventListener('click', handleCancelInIframe, false);
    iframeCloseBtn === null || iframeCloseBtn === void 0 ? void 0 : iframeCloseBtn.addEventListener('click', handleCancelInIframe, false);
  };
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
var ContentEditTabModule = function ContentEditTabModule() {
  ...
  var handleIframeLoad = function handleIframeLoad() {
    ...
    iframeConfirmBtn === null || iframeConfirmBtn === void 0 ? void 0 : iframeConfirmBtn.addEventListener('click', publishContent, false);
    iframeCancelBtn === null || iframeCancelBtn === void 0 ? void 0 : iframeCancelBtn.addEventListener('click', cancelContentEdit, false);
    iframeCloseBtn === null || iframeCloseBtn === void 0 ? void 0 : iframeCloseBtn.addEventListener('click', cancelContentEdit, false);
  };
...
var loadAccordionData = function loadAccordionData(_ref3, callback) {
  ...
  fetch(request).then(_common_helpers_request_helper_js__WEBPACK_IMPORTED_MODULE_1__.handleRequestResponse).then(function (response) {
    ...
    var rootLocationData = response.columns[rootLocationId];
...
var UniversalDiscoveryModule = function UniversalDiscoveryModule(props) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    (_window$ibexa$adminUi = window.ibexa.adminUiConfig.universalDiscoveryWidget.contentTypesLoaders) === null || _window$ibexa$adminUi === void 0 ? void 0 : _window$ibexa$adminUi.forEach(function (contentTypesLoader) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    Promise.all([loadPermissions(), loadVersions()]).then(function (response) {
