...
var getSearchTreeProps = function getSearchTreeProps(_ref) {
  ...
  var getSearchInitiallyExpandedItems = function getSearchInitiallyExpandedItems() {
    if (searchTree === null) {
      return [];
    }
    ...
    var allChildren = (0,_ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_helpers_tree__WEBPACK_IMPORTED_MODULE_0__.getAllChildren)({
      data: searchTree,
      buildItem: buildItem,
  ...
  return {
    ...
    getInitiallyExpandedItems: getSearchInitiallyExpandedItems,
...
/* harmony import */ var _ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ibexa-tree-builder/src/bundle/ui-dev/src/modules/tree-builder/tree.builder.module */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/tree.builder.module.js");
/* harmony import */ var _common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../common/services/taxonomy.tree.service */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/services/taxonomy.tree.service.js");
/* harmony import */ var _common_helpers_array__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../common/helpers/array */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/helpers/array.js");
/* harmony import */ var _common_helpers_getters__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../common/helpers/getters */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/helpers/getters.js");
/* harmony import */ var _common_helpers_tree__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../common/helpers/tree */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/helpers/tree.js");
/* harmony import */ var _common_helpers_actions__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../common/helpers/actions */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/helpers/actions.js");
/* harmony import */ var _common_helpers_languages__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../common/helpers/languages */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/helpers/languages.js");
/* harmony import */ var _common_helpers_search__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../common/helpers/search */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/helpers/search.js");
/* harmony import */ var _common_components_empty_tree_empty_tree__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../common/components/empty-tree/empty.tree */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/components/empty-tree/empty.tree.js");
/* harmony import */ var _components_add_tag_add_tag__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/add-tag/add.tag */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/taxonomy-tree/components/add-tag/add.tag.js");
/* harmony import */ var _common_components_header_content_header_content__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../common/components/header-content/header.content */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/components/header-content/header.content.js");
/* harmony import */ var _components_assign_content_assign_content__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/assign-content/assign.content */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/taxonomy-tree/components/assign-content/assign.content.js");
/* harmony import */ var _common_components_name_content_name_content__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../common/components/name-content/name-content */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/components/name-content/name-content.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var TaxonomyTree = function TaxonomyTree(props) {
  ...
  var getLanguageCode = function getLanguageCode() {
    var _getData;
    var savedLanguageCode = (_getData = (0,_ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_helpers_localStorage__WEBPACK_IMPORTED_MODULE_2__.getData)({
      moduleId: MODULE_ID,
      userId: userId,
      subId: taxonomyName,
      dataId: LANGUAGE_ID
  ...
  var readSubtree = function readSubtree() {
    var _getData2;
    return (_getData2 = (0,_ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_helpers_localStorage__WEBPACK_IMPORTED_MODULE_2__.getData)({
      moduleId: MODULE_ID,
      userId: userId,
      subId: taxonomyName,
      dataId: SUBTREE_ID
    })) !== null && _getData2 !== void 0 ? _getData2 : [];
  };
  var _useState11 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(getLanguageCode()),
    _useState12 = _slicedToArray(_useState11, 2),
    languageCode = _useState12[0],
    setLanguageCode = _useState12[1];
  ...
  var getLoadTreePromise = function getLoadTreePromise() {
    ...
    if ((_subtree$current = subtree.current) !== null && _subtree$current !== void 0 && _subtree$current.length) {
      var entryIds = subtree.current.map(function (entryPath) {
        return (0,_common_helpers_array__WEBPACK_IMPORTED_MODULE_10__.getLastElement)(entryPath.split('/'));
      });
      ...
      return (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_9__.loadTree)({
        taxonomyName: taxonomyName,
        entryIds: entryIds
      });
    }
    return (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_9__.loadTreeRoot)({
      taxonomyName: taxonomyName
    });
  };
  ...
  var renderLabel = function renderLabel(item) {
    var name = (0,_common_helpers_languages__WEBPACK_IMPORTED_MODULE_14__.getTranslatedName)(item.internalItem, languageCode);
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
      className: "c-tt-list-item__link"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_components_name_content_name_content__WEBPACK_IMPORTED_MODULE_20__["default"], {
  ...
  var loadMoreSubitems = function loadMoreSubitems(item) {
    return (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_9__.loadNode)({
      taxonomyName: taxonomyName,
      entryId: item.id
    }).then(function (nodeResponse) {
      var children = nodeResponse.__children;
      var treeItem = (0,_common_helpers_tree__WEBPACK_IMPORTED_MODULE_12__.findItem)([tree], item.path.split('/'));
      if (treeItem) {
        ...
        var nextTreeItem = (0,_common_helpers_tree__WEBPACK_IMPORTED_MODULE_12__.findItem)([nextTree], item.path.split('/'));
  ...
  var callbackToggleExpanded = function callbackToggleExpanded(item, _ref2) {
  ...
  var callbackDeleteElements = function callbackDeleteElements(_ref3) {
    ...
    return (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_9__.deleteElements)(entries, {
      restInfo: props.restInfo,
      taxonomyName: taxonomyName
    }).then(function () {
      var nextSubtree = subtree.current.map(function (path) {
        var ids = path.split('/').map(function (id) {
          return parseInt(id, 10);
        });
        entries.forEach(function (entryId) {
          var index = ids.indexOf(entryId);
          ids = ids.slice(0, index);
        });
        return ids.join('/');
      });
      subtree.current = nextSubtree;
      saveSubtree();
    }).then(function () {
      var message;
      if (selectedData.length === 1) {
      ...
      if (pathIds.length !== pathLength) {
        ...
        (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_9__.loadNode)({
          taxonomyName: taxonomyName,
          entryId: entryId
        }).then(function (nodeResponse) {
          window.location.href = (0,_common_helpers_getters__WEBPACK_IMPORTED_MODULE_11__.getContentLink)(nodeResponse);
        });
      }
    })["catch"](window.ibexa.helpers.notification.showErrorNotification);
  };
  var callbackMoveElements = function callbackMoveElements(_ref4, _ref5) {
    ...
    return (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_9__.moveElements)(entries, {
      restInfo: props.restInfo,
      taxonomyName: taxonomyName
    }).then(loadTreeToState).then(function () {
      var message;
      if (selectedData.length === 1) {
  ...
  var getInitiallyExpandedItems = function getInitiallyExpandedItems(items) {
    var currentlyExpandedIds = items.map(function (item) {
      return item.id;
    });
    var idsToExpand = currentPath.split('/').slice(0, -1).map(function (id) {
      return parseInt(id, 10);
    }).filter(function (id) {
      return !currentlyExpandedIds.includes(id);
    });
    ...
    return [].concat(_toConsumableArray(items), _toConsumableArray(fakeItemsToExpand));
  };
  var renderEmpty = function renderEmpty() {
    if (!isLoaded || (tree === null || tree === void 0 ? void 0 : tree.id) !== undefined) {
      return null;
    }
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_components_empty_tree_empty_tree__WEBPACK_IMPORTED_MODULE_16__["default"], null);
  };
  var renderHeaderContent = function renderHeaderContent() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_components_header_content_header_content__WEBPACK_IMPORTED_MODULE_18__["default"], {
      name: moduleName,
      languageCode: languageCode,
  ...
  var buildItem = function buildItem(item, restProps) {
    return item.internalItem ? item : {
      internalItem: item,
      id: item.id,
      href: (0,_common_helpers_getters__WEBPACK_IMPORTED_MODULE_11__.getContentLink)(item),
      path: (0,_common_helpers_getters__WEBPACK_IMPORTED_MODULE_11__.getPath)(item, restProps),
      subitems: item.__children,
      total: (0,_common_helpers_getters__WEBPACK_IMPORTED_MODULE_11__.getTotal)(item),
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    (_abortControllerSearc = abortControllerSearchRef.current) === null || _abortControllerSearc === void 0 ? void 0 : _abortControllerSearc.abort();
    ...
    searchRequestTimeoutRef.current = setTimeout(function () {
      if (searchValue.length >= MIN_SEARCH_LENGTH) {
        ...
        (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_9__.loadSearchResults)({
          taxonomyName: taxonomyName,
          searchValue: searchValue,
          languageCode: languageCode,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(RestInfoContext.Provider, {
    ...
    value: languageCode
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ibexa.modules.TreeBuilder, _extends({
    moduleId: MODULE_ID,
    moduleName: moduleName,
    userId: userId,
    subId: taxonomyName,
    ...
    getInitiallyExpandedItems: getInitiallyExpandedItems,
    renderHeaderContent: renderHeaderContent,
    actionsType: _ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__.ACTION_TYPE.CONTEXTUAL_MENU,
    dragDisabled: false,
  ...
  }, (0,_common_helpers_search__WEBPACK_IMPORTED_MODULE_15__.getSearchTreeProps)({
...
var treeBuilderConfig = _defineProperty({}, MODULE_ID, {
  menuActions: [{
    ...
    subitems: [{
      priority: 10,
      id: 'add',
      component: _components_add_tag_add_tag__WEBPACK_IMPORTED_MODULE_17__["default"],
      visibleIn: [_ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__.ACTION_PARENT.SINGLE_ITEM]
    }, {
      priority: 30,
      id: 'move',
      component: _ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_actions_move_move__WEBPACK_IMPORTED_MODULE_3__["default"],
      visibleIn: [_ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__.ACTION_PARENT.TOP_MENU, _ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__.ACTION_PARENT.SINGLE_ITEM],
      checkIsDisabled: _common_helpers_actions__WEBPACK_IMPORTED_MODULE_13__.checkIsDisabledMove
    }, {
      priority: 40,
      id: 'delete',
      ...
      visibleIn: [_ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__.ACTION_PARENT.TOP_MENU, _ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__.ACTION_PARENT.SINGLE_ITEM],
      checkIsDisabled: _common_helpers_actions__WEBPACK_IMPORTED_MODULE_13__.checkIsDisabledDelete,
      modalConfirmationBody: Translator.trans( /*@Desc("Are you sure you want to delete selected Taxonomy item(s)?")*/'taxonomy.delete.confirm', {}, 'taxonomy_ui')
    }, {
      priority: 40,
      id: 'assignContent',
      component: _components_assign_content_assign_content__WEBPACK_IMPORTED_MODULE_19__["default"],
      visibleIn: [_ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__.ACTION_PARENT.TOP_MENU, _ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__.ACTION_PARENT.SINGLE_ITEM]
    }]
  }, {
    priority: 30,
    ...
    subitems: [{
      priority: 20,
      id: 'collapse',
      component: _ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_actions_collapse_all_collapse_all__WEBPACK_IMPORTED_MODULE_5__["default"],
      visibleIn: [_ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__.ACTION_PARENT.TOP_MENU, _ibexa_tree_builder_src_bundle_ui_dev_src_modules_tree_builder_tree_builder_module__WEBPACK_IMPORTED_MODULE_8__.ACTION_PARENT.SINGLE_ITEM]
    }]
  }, {
    priority: 40,
...
var Delete = function Delete(_ref) {
  ...
  var isDisabled = (0,_helpers_item__WEBPACK_IMPORTED_MODULE_10__.isItemEmpty)(item) || checkIsDisabled(selectedData);
  var hasSubitems = function hasSubitems(_ref2) {
    var subitems = _ref2.subitems;
    return !!subitems && subitems.length;
  };
...
var SelectAll = function SelectAll(_ref) {
  ...
  var _useContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_components_selected_provider_selected_provider__WEBPACK_IMPORTED_MODULE_4__.SelectedContext),
    dispatchSelectedData = _useContext.dispatchSelectedData;
  var selectedLimit = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_tree_builder_module__WEBPACK_IMPORTED_MODULE_3__.SelectedLimitContext);
  ...
  var selectAll = function selectAll() {
    var allItems = (0,_helpers_tree__WEBPACK_IMPORTED_MODULE_6__.getAllChildren)({
      data: data,
      buildItem: buildItem
    });
...
var ActionList = function ActionList(_ref) {
  var _window$ibexa, _window$ibexa$treeBui, _window$ibexa$treeBui2;
  var item = _ref.item,
    extraClasses = _ref.extraClasses,
    useIconAsLabel = _ref.useIconAsLabel,
    parent = _ref.parent;
  ...
  var actions = ((_window$ibexa = window.ibexa) === null || _window$ibexa === void 0 ? void 0 : (_window$ibexa$treeBui = _window$ibexa.treeBuilder) === null || _window$ibexa$treeBui === void 0 ? void 0 : (_window$ibexa$treeBui2 = _window$ibexa$treeBui[moduleId]) === null || _window$ibexa$treeBui2 === void 0 ? void 0 : _window$ibexa$treeBui2.menuActions) || [];
...
/* harmony export */   "PORTAL_CONTEXTUAL_MENU_ID": () => (/* binding */ PORTAL_CONTEXTUAL_MENU_ID),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _hooks_usePortal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../hooks/usePortal */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/hooks/usePortal.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
var PORTAL_CONTEXTUAL_MENU_ID = 'contextual-menu';
...
var ContextualMenu = function ContextualMenu(_ref) {
  ...
  var _usePortal = (0,_hooks_usePortal__WEBPACK_IMPORTED_MODULE_5__["default"])(PORTAL_CONTEXTUAL_MENU_ID),
    renderPortal = _usePortal.renderPortal;
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    _useState2 = _slicedToArray(_useState, 2),
    isExpanded = _useState2[0],
    setIsExpanded = _useState2[1];
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true),
    _useState4 = _slicedToArray(_useState3, 2),
    isClosable = _useState4[0],
    setIsClosable = _useState4[1];
  ...
  var toggleMenuOnClickOutside = function toggleMenuOnClickOutside(event) {
  ...
  })), isExpanded && renderPortal( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ContextualMenuContext.Provider, {
...
var DndProvider = function DndProvider(_ref) {
  ...
  var _useContext2 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_components_placeholder_provider_placeholder_provider__WEBPACK_IMPORTED_MODULE_4__.PlaceholderContext),
    ...
    setPlaceholderData = _useContext2.setPlaceholderData,
  ...
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({}),
    _useState2 = _slicedToArray(_useState, 2),
    currentMousePosition = _useState2[0],
    setCurrentMousePosition = _useState2[1];
...
var ListItemSingle = function ListItemSingle(props) {
  ...
  var setIndentHeightWrapper = function setIndentHeightWrapper() {
    ...
    if (lastItemRef.current) {
      var veticalLineStartPosition = isRoot && rootSelectionDisabled ? DISABLED_ROOT_SELECTION_VERTICAL_LINE_OFFSET : 0;
      setIndentHeight(lastItemRef.current.offsetTop - veticalLineStartPosition);
    }
  };
  ...
  itemAttrs.className = (0,_ibexa_admin_ui_src_bundle_ui_dev_src_modules_common_helpers_css_class_names__WEBPACK_IMPORTED_MODULE_1__.createCssClassNames)(_defineProperty({
    ...
    'c-tb-list-item-single--hovered': isHovered,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PORTAL_PLACEHOLDER_SOURCE_ID": () => (/* binding */ PORTAL_PLACEHOLDER_SOURCE_ID),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _hooks_usePortal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../hooks/usePortal */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/hooks/usePortal.js");
...
var PORTAL_PLACEHOLDER_SOURCE_ID = 'placeholder-source';
var ListItem = function ListItem(props) {
  ...
  var _usePortal = (0,_hooks_usePortal__WEBPACK_IMPORTED_MODULE_7__["default"])(PORTAL_PLACEHOLDER_SOURCE_ID),
    renderPortal = _usePortal.renderPortal;
  var _useContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_dnd_provider_dnd_provider__WEBPACK_IMPORTED_MODULE_6__.DraggableContext),
    currentMousePosition = _useContext.currentMousePosition;
  ...
  var renderContent = function renderContent() {
    ...
    if (isSource && groupingItemId.current === item.id) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_placeholder_source_placeholder_source__WEBPACK_IMPORTED_MODULE_3__["default"], null), renderPortal( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prop-types */ "prop-types");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _list_item_list_item__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../list-item/list.item */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/components/list-item/list.item.js");
...
/* harmony import */ var _placeholder_provider_placeholder_provider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../placeholder-provider/placeholder.provider */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/components/placeholder-provider/placeholder.provider.js");
/* harmony import */ var _width_container_width_container__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../width-container/width.container */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/components/width-container/width.container.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
...
var List = function List(_ref) {
  ...
  var _useContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_placeholder_provider_placeholder_provider__WEBPACK_IMPORTED_MODULE_4__.PlaceholderContext),
    placeholderData = _useContext.placeholderData;
  var _useContext2 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_width_container_width_container__WEBPACK_IMPORTED_MODULE_5__.WidthContainerContext),
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
    className: "c-tb-list"
  }, placeholderIndex === 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_placeholder_destination_placeholder_destination__WEBPACK_IMPORTED_MODULE_3__["default"], null), subitems.map(function (subitem, index) {
    var _subitem$id;
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_list_item_list_item__WEBPACK_IMPORTED_MODULE_2__["default"], {
      parents: parents,
      item: subitem,
      index: index,
...
var EXPAND_ID = 'expanded-nodes';
var LocalStorageExpandConnector = function LocalStorageExpandConnector(_ref) {
  var children = _ref.children,
    getInitiallyExpandedItems = _ref.getInitiallyExpandedItems,
    isLocalStorageActive = _ref.isLocalStorageActive;
  var prevInitialItemsIds = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)('');
  var _useLocalStorage = (0,_hooks_useLocalStorage__WEBPACK_IMPORTED_MODULE_3__["default"])(EXPAND_ID),
  ...
  var getInitialValues = function getInitialValues() {
    var items = isLocalStorageActive && getLocalStorageData() || [];
    return getInitiallyExpandedItems(items);
  };
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    var initialIds = initialValues.map(function (item) {
      return item.id;
    }).join(',');
...
LocalStorageExpandConnector.propTypes = {
  ...
  getInitiallyExpandedItems: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func.isRequired),
...
/***/ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/components/portal-provider/portal.provider.js":
/*!****************************************************************************************************************************!*\
  !*** ./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/components/portal-provider/portal.provider.js ***!
  \****************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var PortalContext = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)();
var transformToObject = function transformToObject(array) {
  var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {
    return null;
  };
  return array.reduce(function (object, id) {
    return _objectSpread(_objectSpread({}, object), {}, _defineProperty({}, id, callback(id)));
  }, {});
};
var PortalProvider = function PortalProvider(_ref) {
  var children = _ref.children,
    portals = _ref.portals;
  var portalRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(transformToObject(portals));
  var prevPosition = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(transformToObject(portals, function () {
    return {};
  }));
  ...
  var renderPortal = function renderPortal(id, portalChildren, getPosition) {
    var _getPosition = getPosition(),
      x = _getPosition.x,
      y = _getPosition.y;
    if (x !== prevPosition.current[id].x || y !== prevPosition.current[id].y) {
      prevPosition.current[id] = {
        x: x,
        y: y
      };
      portalRef.current[id].style.left = "".concat(x, "px");
      portalRef.current[id].style.top = "".concat(y, "px");
    }
    return /*#__PURE__*/react_dom__WEBPACK_IMPORTED_MODULE_1___default().createPortal(portalChildren, portalRef.current[id]);
  };
  var portalContextValues = transformToObject(portals, function (id) {
    return {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    portals.forEach(function (portalId) {
      var portal = window.document.createElement('div');
      portalRef.current[portalId] = portal;
      portal.classList.add('c-tb-portal', "c-tb-portal--".concat(portalId, "-").concat(moduleId));
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PortalContext.Provider, {
    value: portalContextValues
  }, children);
};
PortalProvider.propTypes = {
  children: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().node.isRequired),
  portals: prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().string.isRequired)).isRequired
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PortalProvider);
...
var WidthContainer = function WidthContainer(_ref) {
  ...
  var containerRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  var scrollRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  ...
  var saveWidth = function saveWidth(value) {
    var cookieName = "ibexa-tb-".concat(moduleId, "-").concat(userId, "-container-width");
  ...
  var scrollableWrapperClassName = (0,_ibexa_admin_ui_src_bundle_ui_dev_src_modules_common_helpers_css_class_names__WEBPACK_IMPORTED_MODULE_2__.createCssClassNames)({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (dynamicallyLoadedChildren) {
      var _scrollRef$current$ch;
      if (((_scrollRef$current$ch = scrollRef.current.childNodes[0]) === null || _scrollRef$current$ch === void 0 ? void 0 : _scrollRef$current$ch.offsetHeight) >= getConfig('scrollTop')) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    return function () {
      ...
      clearDocumentResizingListeners();
      (_scrollRef$current = scrollRef.current) === null || _scrollRef$current === void 0 ? void 0 : _scrollRef$current.removeEventListener('scroll', scrollListener, false);
    };
  }, []);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
...
/***/ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/hooks/usePortal.js":
/*!*************************************************************************************************!*\
  !*** ./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/hooks/usePortal.js ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_portal_provider_portal_provider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/portal-provider/portal.provider */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/components/portal-provider/portal.provider.js");


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (portalId) {
  var portals = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_components_portal_provider_portal_provider__WEBPACK_IMPORTED_MODULE_1__.PortalContext);
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ibexa_admin_ui_src_bundle_ui_dev_src_modules_common_helpers_css_class_names__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ibexa-admin-ui/src/bundle/ui-dev/src/modules/common/helpers/css.class.names */ "./vendor/ibexa/admin-ui/src/bundle/ui-dev/src/modules/common/helpers/css.class.names.js");
/* harmony import */ var _components_portal_provider_portal_provider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/portal-provider/portal.provider */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/components/portal-provider/portal.provider.js");
...
/* harmony import */ var _components_contextual_menu_contextual_menu__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/contextual-menu/contextual.menu */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/components/contextual-menu/contextual.menu.js");
/* harmony import */ var _components_list_item_list_item__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/list-item/list.item */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/components/list-item/list.item.js");
/* harmony import */ var _helpers_item__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./helpers/item */ "./vendor/ibexa/tree-builder/src/bundle/ui-dev/src/modules/tree-builder/helpers/item.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
...
var TreeBuilderModule = function TreeBuilderModule(_ref) {
  ...
  var renderContent = function renderContent() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      rootSelectionDisabled: rootSelectionDisabled,
      isExpanded: true,
      subitems: !(0,_helpers_item__WEBPACK_IMPORTED_MODULE_16__.isItemEmpty)(tree) ? [tree] : [],
      depth: -1
    }), children);
  };
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_portal_provider_portal_provider__WEBPACK_IMPORTED_MODULE_3__["default"], {
    portals: [_components_contextual_menu_contextual_menu__WEBPACK_IMPORTED_MODULE_14__.PORTAL_CONTEXTUAL_MENU_ID, _components_list_item_list_item__WEBPACK_IMPORTED_MODULE_15__.PORTAL_PLACEHOLDER_SOURCE_ID]
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
TreeBuilderModule.propTypes = {
  ...
  initiallySelectedItemsIds: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().array),
  getInitiallyExpandedItems: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
...
TreeBuilderModule.defaultProps = {
  ...
  tree: null,
  initiallySelectedItemsIds: [],
  getInitiallyExpandedItems: function getInitiallyExpandedItems(items) {
    return items;
  },
  subId: 'default',
