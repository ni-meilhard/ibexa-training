...
(function (global, doc, ibexa, Translator, Routing) {
  var _ibexa$productCatalog, _ibexa$productCatalog2, _ibexa$productCatalog3;
  ...
  var filtersConfig = [];
  var filtersConfigClassMap = (_ibexa$productCatalog = ibexa === null || ibexa === void 0 ? void 0 : (_ibexa$productCatalog2 = ibexa.productCatalog) === null || _ibexa$productCatalog2 === void 0 ? void 0 : (_ibexa$productCatalog3 = _ibexa$productCatalog2.catalogs) === null || _ibexa$productCatalog3 === void 0 ? void 0 : _ibexa$productCatalog3.filters) !== null && _ibexa$productCatalog !== void 0 ? _ibexa$productCatalog : {};
  var currentPage = 1;
  ...
  var changeFieldNameToQueryParamName = function changeFieldNameToQueryParamName(fieldName) {
  ...
  var refreshProductsList = function refreshProductsList() {
    ...
    if (searchInput.value != '') {
      queryParams.products_preview.search = {
    ...
    Object.entries(filtersConfig).forEach(function (_ref2) {
      ...
      var queryParamName = changeFieldNameToQueryParamName(filterConfigKey);
      var queryParamValue = filterConfig.getRequestValue();
    ...
    var catalogPreviewUrl = Routing.generate('ibexa.product_catalog.catalog.products.preview.list', queryParams);
    ...
    fetch(catalogPreviewUrl, {
      mode: 'same-origin',
      credentials: 'same-origin'
    }).then(ibexa.helpers.request.getJsonFromResponse).then(function (response) {
      var fragment = doc.createDocumentFragment();
...
var BaseFilterConfig = /*#__PURE__*/function () {
  ...
  _createClass(BaseFilterConfig, [{
    ...
    value: function init() {
      ...
      (_this$tagsPopupMenuIt = this.tagsPopupMenuItems) === null || _this$tagsPopupMenuIt === void 0 ? void 0 : _this$tagsPopupMenuIt.forEach(function (popupMenuItem) {
  ...
  _createClass(TaxonomyFilterConfig, [{
    ...
    value: function getItems() {
      ...
      return this.sourceInput.value.split(',').filter(function (id) {
        ...
        return {
          label: (_taxonomyEntry$intern = taxonomyEntry === null || taxonomyEntry === void 0 ? void 0 : (_taxonomyEntry$intern2 = taxonomyEntry.internalItem) === null || _taxonomyEntry$intern2 === void 0 ? void 0 : _taxonomyEntry$intern2.name) !== null && _taxonomyEntry$intern !== void 0 ? _taxonomyEntry$intern : _this2.getCategoryLabel(id),
          value: id
        };
      });
    }
...
/* harmony import */ var _ibexa_admin_ui_src_bundle_ui_dev_src_modules_common_icon_icon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ibexa-admin-ui/src/bundle/ui-dev/src/modules/common/icon/icon */ "./vendor/ibexa/admin-ui/src/bundle/ui-dev/src/modules/common/icon/icon.js");
/* harmony import */ var _common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common/services/taxonomy.tree.service */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/services/taxonomy.tree.service.js");
/* harmony import */ var _common_helpers_getters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../common/helpers/getters */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/helpers/getters.js");
/* harmony import */ var _common_helpers_tree__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../common/helpers/tree */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/helpers/tree.js");
/* harmony import */ var _common_helpers_languages__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../common/helpers/languages */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/helpers/languages.js");
/* harmony import */ var _common_helpers_search__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../common/helpers/search */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/helpers/search.js");
/* harmony import */ var _common_components_empty_tree_empty_tree__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../common/components/empty-tree/empty.tree */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/components/empty-tree/empty.tree.js");
/* harmony import */ var _common_components_not_translated_info_not_translated_info__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../common/components/not-translated-info/not.translated.info */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/components/not-translated-info/not.translated.info.js");
/* harmony import */ var _common_components_name_content_name_content__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../common/components/name-content/name-content */ "./vendor/ibexa/taxonomy/src/bundle/ui-dev/src/modules/common/components/name-content/name-content.js");
...
var SelectIbexaTag = function SelectIbexaTag(props) {
  ...
  var loadTreeToState = function loadTreeToState() {
    return (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_3__.loadTreeRoot)({
      taxonomyName: taxonomyName
    }).then(function (rootResponse) {
      var _rootResponse = _slicedToArray(rootResponse, 1),
        rootItem = _rootResponse[0];
      return (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_3__.loadNode)({
        taxonomyName: taxonomyName,
        entryId: rootItem.id
  ...
  var renderLabel = function renderLabel(item) {
    ...
    var name = (0,_common_helpers_languages__WEBPACK_IMPORTED_MODULE_6__.getTranslatedName)(item.internalItem, languageCode);
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("label", {
      htmlFor: "ibexa-tb-row-selected-".concat(moduleId, "-").concat(id),
      className: "c-tt-list-item__link"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_components_name_content_name_content__WEBPACK_IMPORTED_MODULE_10__["default"], {
      searchActive: searchActive,
      searchValue: searchValue,
      name: name
    }), !(0,_common_helpers_languages__WEBPACK_IMPORTED_MODULE_6__.hasTranslation)(internalItem, languageCode) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ibexa_admin_ui_src_bundle_ui_dev_src_modules_common_icon_icon__WEBPACK_IMPORTED_MODULE_2__["default"], {
      name: "warning-triangle",
  ...
  var loadMoreSubitems = function loadMoreSubitems(item) {
    return (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_3__.loadNode)({
      ...
      var treeItem = (0,_common_helpers_tree__WEBPACK_IMPORTED_MODULE_5__.findItem)([tree], item.path.split('/'));
      if (treeItem) {
        ...
        var nextTreeItem = (0,_common_helpers_tree__WEBPACK_IMPORTED_MODULE_5__.findItem)([nextTree], item.path.split('/'));
  ...
  var renderEmpty = function renderEmpty() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_components_empty_tree_empty_tree__WEBPACK_IMPORTED_MODULE_8__["default"], null);
  };
  var buildItem = function buildItem(item) {
    ...
    return item.internalItem ? item : {
      internalItem: item,
      id: item.id,
      path: (0,_common_helpers_getters__WEBPACK_IMPORTED_MODULE_4__.getPath)(item, restProps),
      subitems: item.__children,
      total: (0,_common_helpers_getters__WEBPACK_IMPORTED_MODULE_4__.getTotal)(item),
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    searchRequestTimeoutRef.current = setTimeout(function () {
      if (searchValue !== '') {
        ...
        (0,_common_services_taxonomy_tree_service__WEBPACK_IMPORTED_MODULE_3__.loadSearchResults)({
          taxonomyName: taxonomyName,
          searchValue: searchValue,
          languageCode: languageCode,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ibexa.modules.TreeBuilder, _extends({
    ...
    getInitiallyExpandedItems: function getInitiallyExpandedItems() {
      return tree ? [buildItem(tree)] : [];
    },
  ...
  }, (0,_common_helpers_search__WEBPACK_IMPORTED_MODULE_7__.getSearchTreeProps)({
    searchTree: searchTree,
    searchActive: searchActive,
    buildItem: buildItem
  })), renderEmpty(), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_components_not_translated_info_not_translated_info__WEBPACK_IMPORTED_MODULE_9__["default"], {
    languageCode: languageCode
  }));
};
