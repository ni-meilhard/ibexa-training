...
(function (global, doc, ibexa, Routing, Translator, bootstrap) {
  ...
  var addField = function addField(_ref4) {
    ...
    fetch(generateRequest('add', bodyData, languageCode)).then(ibexa.helpers.request.getTextFromResponse).then(function (response) {
      ...
      loadingField === null || loadingField === void 0 ? void 0 : loadingField.remove();
      afterChangeGroup();
  ...
  var validateForm = function validateForm() {
    ...
    Object.entries(fieldDefinitionsStatuses).forEach(function (_ref6) {
      var _ref7 = _slicedToArray(_ref6, 2),
        fieldDefinitionIdentifier = _ref7[0],
        inputsStatus = _ref7[1];
...
(function (global, doc, ibexa, React, ReactDOM) {
  ...
  var attachEvents = function attachEvents(container) {
    ...
    deleteBtn === null || deleteBtn === void 0 ? void 0 : deleteBtn.addEventListener('click', resetStartingLocation, false);
  ...
  var toggleDisabledState = function toggleDisabledState(container) {
    ...
    deleteBtn === null || deleteBtn === void 0 ? void 0 : deleteBtn.classList.toggle('disabled', isDisabled);
  };
  ...
  var updateGroupHeader = function updateGroupHeader(container) {
    container.querySelectorAll('.ibexa-page-select-items__select-all-items').forEach(function (selectAllItemsCheckbox) {
      ...
      if (isAnyBlockUnchecked) {
        ...
        actionLabelNode.innerHTML = Translator.trans( /*@Desc("Unselect all")*/'item.unselect_all', {}, 'ezplatform_page_fieldtype');
      }
      if (warningNode) {
...
(function (global, doc) {
  ...
  var updateUnitLabels = function updateUnitLabels(_ref3) {
    var currentTarget = _ref3.currentTarget;
    var container = getContainer(currentTarget);
    var unit = currentTarget.querySelector("[value=\"".concat(currentTarget.value, "\"]")).innerHTML;
  ...
  var setUnit = function setUnit(_ref4) {
  ...
  var addEventsListeners = function addEventsListeners(container) {
    ...
    var defaultValueInput = container.querySelector('.ibexa-measurement-default-value--simple .ibexa-input');
    ...
    unitSelect.addEventListener('change', updateUnitLabels, false);
    unitSelect.addEventListener('change', setUnit, false);
    minValueInput.addEventListener('change', function () {
      defaultValueInput.min = minValueInput.value;
    ...
    maxValueInput.addEventListener('change', function () {
      defaultValueInput.max = maxValueInput.value;
