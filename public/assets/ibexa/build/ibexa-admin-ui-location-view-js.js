...
/***/ "./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/helpers/form.data.helper.js":
/*!*****************************************************************************************************!*\
  !*** ./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/helpers/form.data.helper.js ***!
  \*****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getFormDataFromObject);

/***/ }),

/***/ "./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/price.sku.search.js":
/*!*********************************************************************************************!*\
  !*** ./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/price.sku.search.js ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers_form_data_helper_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/form.data.helper.js */ "./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/helpers/form.data.helper.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
...
(function (global, doc, ibexa) {
  var skuWrapper = doc.querySelector('.ibexa-sku-search--price');
  if (!skuWrapper) {
    return;
  }
  var searchInput = skuWrapper.querySelector('.ibexa-sku-search__input');
  var searchButton = skuWrapper.querySelector('.ibexa-btn--search');
  var searchResults = skuWrapper.querySelector('.ibexa-sku-search__results');
  var tableWrapper = skuWrapper.querySelector('.ibexa-price-management');
  var saveButton = skuWrapper.querySelector('.ibexa-btn--save');
  var enterKeyCode = 13;
  var skuData = {};
  ...
  var search = function search(skuCode) {
    ...
    var request = new Request(Routing.generate('ibexa.commerce.menu.admin.fetch_prices', {
      shopId: 'MAIN',
      currency: currency
    }), {
      method: 'POST',
      body: (0,_helpers_form_data_helper_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
        sku: sku
      }),
      mode: 'same-origin',
      credentials: 'same-origin'
    });
    fetch(request).then(ibexa.helpers.request.getJsonFromResponse).then(handleSearchResponse)["catch"](ibexa.helpers.notification.showErrorNotification);
  };
  var handleSearchResponse = function handleSearchResponse(response) {
    if (response.result.message !== undefined) {
      var notFoundMessage = Translator.trans( /*@Desc("Product not found")*/'product.not_found', {}, 'price_stock_ui');
  ...
  var renderPriceTable = function renderPriceTable(variantSku) {
    ...
    var tableHeaderText = Translator.trans( /*@Desc("Prices for %contentName%, List price %price%")*/'price.table.header', {
    ...
    var renderedTableTemplate = tableTemplate.replaceAll('{{ header_text }}', tableHeaderText).replace('{{ variant_sku }}', variantSku);
    var tableWrapperContainer = doc.createElement('div');
    tableWrapperContainer.insertAdjacentHTML('beforeend', renderedTableTemplate);
    var priceTableWrapper = tableWrapperContainer.querySelector('.ibexa-price-table');
    ...
    skuPrices.forEach(function (price) {
      ...
      var customerGroupSelect = row.querySelector('.ibexa-table__customer-group-select');
    ...
    var currencySelect = tableFragment.querySelector('.ibexa-table-header__price-select');
    var addPriceButton = tableFragment.querySelector('.ibexa-btn--add-price');
    ...
    addPriceButton.addEventListener('click', function (event) {
      return addPriceRow(event.target.closest('.ibexa-price-table').querySelector('table'));
    }, false);
  ...
  var save = function save() {
    var tables = tableWrapper.querySelectorAll('.ibexa-price-table');
    tables.forEach(function (table) {
      ...
      var prices = tableRows.map(function (tableRow) {
        var groupId = tableRow.querySelector('.ibexa-table__customer-group-select').value;
    ...
    var request = new Request(Routing.generate('ibexa.commerce.menu.admin.update_prices'), {
      method: 'POST',
      body: (0,_helpers_form_data_helper_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
        prices: skuData
      }),
    ...
    fetch(request).then(ibexa.helpers.request.getJsonFromResponse).then(function (response) {
      if (response.message !== '') {
        var notSavedMessage = Translator.trans( /*@Desc("Couldn't save the prices")*/'price.not_saved', {}, 'price_stock_ui');
        ibexa.helpers.notification.showErrorNotification(notSavedMessage);
      } else {
        var savedMessage = Translator.trans( /*@Desc("Prices saved successfully")*/'price.saved', {}, 'price_stock_ui');
...
/***/ "./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/stock.sku.search.js":
/*!*********************************************************************************************!*\
  !*** ./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/stock.sku.search.js ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(function (global, doc, ibexa) {
  var skuWrapper = doc.querySelector('.ibexa-sku-search--stock');
  if (!skuWrapper) {
    return;
  }
  var searchInput = skuWrapper.querySelector('.ibexa-sku-search__input');
  ...
  var searchResults = skuWrapper.querySelector('.ibexa-sku-search__results');
  var saveButton = skuWrapper.querySelector('.ibexa-btn--save');
  var skuUpdateWrapper = skuWrapper.querySelector('.ibexa-stock-management');
  var enterKeyCode = 13;
  var skuData = {};
  var handleKeyUp = function handleKeyUp(event) {
    var keyCode = event.charCode || event.keyCode || 0;
  ...
  var search = function search(skuCode) {
    var sku = skuCode || searchInput.value;
    var request = new Request(Routing.generate('ibexa.commerce.menu.admin.fetch_stock', {
      shopId: 'MAIN'
    }), {
      method: 'POST',
      body: (0,_helpers_form_data_helper_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
  ...
  var renderSkuUpdate = function renderSkuUpdate(_ref) {
    ...
    var stockUpdateWrapper = skuUpdateContainer.querySelector('.ibexa-stock-update');
    var onStockInput = stockUpdateWrapper.querySelector('.ibexa-stock-update__input--on-stock');
    var stockTextInput = stockUpdateWrapper.querySelector('.ibexa-stock-update__input--stock-text');
  ...
  var save = function save() {
    var stockUpdateNodes = skuUpdateWrapper.querySelectorAll('.ibexa-stock-update');
    stockUpdateNodes.forEach(function (stockUpdateNode) {
      var variantSku = stockUpdateNode.dataset.sku;
      var onStockInput = stockUpdateNode.querySelector('.ibexa-stock-update__input--on-stock');
      var stockTextInput = stockUpdateNode.querySelector('.ibexa-stock-update__input--stock-text');
      skuData.stock[variantSku].stock = onStockInput.value;
      skuData.stock[variantSku].stockSign = stockTextInput.value;
    });
    var request = new Request(Routing.generate('ibexa.commerce.menu.admin.update_stock'), {
      method: 'POST',
      body: (0,_helpers_form_data_helper_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
        stock: skuData
      }),
    ...
    fetch(request).then(ibexa.helpers.request.getJsonFromResponse).then(function (response) {
      if (response.message !== undefined) {
        var notSavedMessage = Translator.trans( /*@Desc("Couldn't save stock")*/'stock.not_saved', {}, 'price_stock_ui');
        ibexa.helpers.notification.showErrorNotification(notSavedMessage);
      } else {
        var savedMessage = Translator.trans( /*@Desc("Stock saved successfully")*/'stock.saved', {}, 'price_stock_ui');
        ibexa.helpers.notification.showSuccessNotification(savedMessage);
      }
    })["catch"](ibexa.helpers.notification.showErrorNotification);
  };
...
/***/ "./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/user.overview.chart.js":
/*!************************************************************************************************!*\
  !*** ./vendor/ibexa/commerce-shop/src/bundle/Eshop/Resources/public/js/user.overview.chart.js ***!
  \************************************************************************************************/
/***/ (() => {
...
(function (global, doc) {
  var chart = doc.querySelector('.ibexa-commerce-user-overview');
  if (!chart) {
    return;
  }
  var chartData = chart.dataset.chartData;
  c3.generate({
    bindto: '.ibexa-commerce-user-overview',
    padding: {
      right: 35
    },
    data: {
