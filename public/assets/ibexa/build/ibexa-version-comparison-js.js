...
(function (global, doc, Routing) {
  ...
  var loadVersion = function loadVersion() {
    if (comparisonButton.getAttribute('hidden')) {
  ...
  var redirectToSideBySide = function redirectToSideBySide() {
    ...
    global.location.href = Routing.generate('ibexa.version.side_by_side_comparison', {
  ...
  var redirectToComparison = function redirectToComparison() {
    ...
    var versionNoA = versionA.options[versionA.selectedIndex].value;
    var versionNoB = versionB.options[versionB.selectedIndex].value;
    global.location.href = Routing.generate('ibexa.version.compare', {
      contentInfoId: contentInfoId,
      versionNoA: versionNoA,
      versionNoB: versionNoB
    });
