...
(function (global, doc, ibexa, Translator, bootstrap) {
  ...
  var handleCopyLink = function handleCopyLink(event) {
    ...
    if (!global.navigator.clipboard) {
      ibexa.helpers.notification.showErrorNotification(Translator.trans( /*@Desc("Cannot copy invitation link due to browser limitations.")*/'table.invitations.actions.copy_link.copy_clipboard_error', {}, 'corporate_account'));
      return;
    }
    var copiedTooltipTitle = Translator.trans( /*@Desc("Copied!")*/'table.invitations.actions.copy_link.copied_tooltip.title', {}, 'corporate_account');
...
(function (global, doc, bootstrap, Translator) {
  ...
  var prepareModal = function prepareModal(statusChangeType, username, href) {
    ...
    if (statusChangeType === 'activate') {
      var modalTitle = Translator.trans( /*@Desc("Activate user")*/'modal.user_status_change.title.activate', {}, 'corporate_account');
      ...
      var _modalTitle = Translator.trans( /*@Desc("De-activate user")*/'modal.user_status_change.title.deactivate', {}, 'corporate_account');
