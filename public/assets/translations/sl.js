...
t.add("This value is not a valid captcha.", "Ta vrednost ni veljavna captcha.", "validators", "sl");
t.add("The captcha was not resolved on the right domain.", "Captcha ni bila re\u0161ena na pravilni domeni.", "validators", "sl");
})(Translator);
